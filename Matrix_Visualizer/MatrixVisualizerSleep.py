...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('墨现科技--压感数据可视化')
        ...
        self.row_data.setRange(64, 1000)
        self.col_data.setRange(32, 1000)
    ...
    def screen_shot(self):
        try:
            ...
            hwnd = FindWindow(None, "墨现科技--压感数据可视化")
